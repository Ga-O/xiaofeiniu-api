...
(NULL, '草鱼片', 'r9470.jpg', '35', '选鲜活草鱼，切出鱼片冷鲜保存。锅开后再煮1分钟左右即可食用', '1'),
(NULL, '脆皮肠', 'r9470.jpg', '15', '锅开后再煮3分钟左右即可食用', '1'),
(NULL, '午餐肉', 'r9470.jpg', '18', '锅开后再煮2分钟左右即可食用', '1'),
(NULL, '牛仔骨', 'r9470.jpg', '43', '牛仔骨又称牛小排，选自资质合格的厂家生产配送。锅开后再煮5分钟左右即可食用', '1'),
(NULL, '新西兰羊肉卷', 'r9017.jpg', '52', '选用新西兰羔羊肉的前胸和肩胛为原料，在国内经过分割、压制成型，肥瘦均匀。锅开后涮30秒左右即可食用', '1'),
(NULL, '捞派嫩羊肉', 'r9017.jpg', '48', '海底捞只选用生长周期达到6—8个月的草原羔羊，肉嫩筋少而膻味少', '1'),
(NULL, '澳洲肥牛', 'r4760.jpg', '68', '百分百澳洲牛肉的前胸部位，口感香嫩，汁浓味厚。锅开后涮30秒即可食用', '1'),
(NULL, '捞派鸭肠', 'r4760.jpg', '19', '捞派鸭肠，选用资质和证件齐全的屠宰场鸭肠。经过掏肠、去大油、结石、抛肠、清洗、刀工去小油、清洗等步骤', '1'),
(NULL, '手切羊肉', 'r9017.jpg', '46', '甄选12月龄以下羔羊后腿以及羊霖，经过切配、装盘而成。锅开后再煮1分钟左右即可食用。', '1'),
(NULL, '猪蹄', 'r4760.jpg', '35', '猪蹄斩成小块，经过清洗，过水，用十余种符合国家食品安全的食材一起炖煮而成。锅开后再煮5分钟即可食用', '1'),
(NULL, '冻虾', 'r4760.jpg', '29', '将活虾冷冻而成。肉质脆嫩，锅开后再煮4分钟左右即可食用', '2'),
(NULL, '青斑', 'r4760.jpg', '36', '经过宰杀、去内脏、清洗、装盘而成。锅开后鱼片煮1分钟左右，鱼头、鱼排煮4分钟即可食用', '2'),
(NULL, '活虾', 'r4760.jpg', '48', '选自广东湛江、北海区域南美白虾，清洗干净装盘，锅开后再煮2分钟左右即可食用', '2'),
(NULL, '鱿鱼须', 'r4760.jpg', '28', '选用鱿鱼触角，速冻保鲜。锅开后再煮5分钟左右即可食用', '2'),
(NULL, '大闸蟹', 'r4760.jpg', '50', '大闸蟹又称河蟹、毛蟹、清水蟹、大闸蟹或螃蟹，顾客可根据情况选择生、熟两种大闸蟹，生的大闸蟹，锅开后再煮8分钟左右即可食用', '2'),
(NULL, '油蛤', 'r4760.jpg', '12', '经过宰杀、去内脏、清洗、装盘而成。锅开后再煮4分钟左右即可食用', '2'),
(NULL, '油条虾', 'r4760.jpg', '36', '油条炸制后，裹入虾滑而成。将油条的香味和虾滑的脆嫩结合在一起，锅开后再煮3分钟左右即可食用', '2'),
(NULL, '扇贝', 'r9302.jpg', '27', '鲜活扇贝，餐前宰杀后上桌。锅开后再煮4分钟左右即可食用', '2'),
(NULL, '无刺巴沙鱼', 'r9302.jpg', '30', '巴沙鱼口味鲜嫩，且无刺无腥味，特别适合老人、小孩食用', '2'),
(NULL, '撒尿牛肉丸', 'r9302.jpg', '35', '选用牛后腿部位牛霖，经过排酸、绞碎、搅打成的牛肉滑，捏成丸子后，里面裹入用老鸡、火腿等精心熬制的汤', '3'),
(NULL, '西式牛肉滑', 'r9017.jpg', '41', '选用牛后腿部位，经过排酸、绞碎、搅打而成的牛肉滑，放入香菇、芹菜粒等原料，配以蛋黄。开锅后由服务员搅拌均匀、做成小丸下入', '3'),
(NULL, '招牌虾滑', 'r9017.jpg', '30', '精选湛江、北海区域出产的南美品种白虾虾仁，配以盐和淀粉等调料制作而成。虾肉含量越高，虾滑口感越纯正', '3'),
(NULL, '精品肉丸', 'r9017.jpg', '19', '选自资质合格的厂家。锅开后浮起来后再煮3分钟左右即可食用', '3'),
(NULL, '手工墨鱼丸', 'r9017.jpg', '28', '墨鱼经破碎、搅拌等工艺，再配以秘制调料混合而成。锅开后再浮起来再煮3分钟即可食用', '1'),
(NULL, '丸类组合', 'r9017.jpg', '31', '丸类组合', '3'),
(NULL, '包心生菜', 'r9017.jpg', '16', '包心生菜', '4'),
(NULL, '蒿子秆', 'r9017.jpg', '20', '经过挑选、清洗、切配、装盘而成，锅开后再煮1分钟左右即可食用', '4'),
(NULL, '竹笋', 'r9017.jpg', '22', '竹笋清洗后对剖切开，装盘，口感脆爽，锅开后再煮4分钟左右即可食用', '4'),
(NULL, '土豆', 'r9017.jpg', '10', '经过去泥、挑选、去皮、清洗、切配、装盘而成。锅开后再煮4分钟左右即可食用', '4'),
(NULL, '山药', 'r9017.jpg', '18', '经过去泥、挑选、去皮、清洗、切配、装盘而成。锅开后再煮3分钟左右即可食用', '4'),
(NULL, '冬瓜', 'r9017.jpg', '15', '经过去泥、挑选、去皮、清洗、切配、装盘而成。锅开后再煮1分钟即可食用，不宜久煮，否则会煮溶', '4'),
(NULL, '白萝卜', 'r9017.jpg', '9', '经过去泥、挑选、去皮、清洗、切配、装盘而成。锅开后再煮3分钟左右即可食用', '4'),
(NULL, '红薯', 'r9017.jpg', '9.9', '经过去泥、挑选、去皮、清洗、切配、装盘而成。口感香甜，锅开后再煮4分钟左右即可食用', '4'),
(NULL, '小白菜', 'r9017.jpg', '12', '经过挑选、清洗、切配、装盘而成。锅开后再煮2分钟左右即可食用', '4'),
(NULL, '娃娃菜', 'r9017.jpg', '16', '通过挑选、清洗、切配、装盘而成，易吸收锅底汤汁，锅开后再煮2分钟左右即可食用', '4'),
(NULL, '炸豆衣', 'r9017.jpg', '22', '鲜豆皮酿制，豆香味浓郁，锅开后涮30秒左右即可食用', '4'),
(NULL, '捞派豆花', 'r9017.jpg', '19', '采用优质大豆磨浆，经传统手工工艺压制而成。锅开后再煮5分钟左右即可食用。配上豆花蘸碟，口味更突出', '4'),
(NULL, '有机香菇', 'r9017.jpg', '28', '经过挑选、清洗、装盘而成。锅开后再煮2分钟左右即可食用', '5'),
(NULL, '木耳', 'r9017.jpg', '24', '经过浸泡、挑选、装盘而成。锅开后再煮3分钟左右即可食用', '5'),
(NULL, '平菇', 'r9017.jpg', '22', '经过挑选、清洗、装盘而成。脆嫩而肥厚，锅开后再煮5分钟左右即可食用', '5'),
(NULL, '椎茸', 'r9017.jpg', '36', '经过清洗、切配、装盘而成。锅开后再煮4分钟左右即可食用', '5'),
(NULL, '竹荪', 'r9017.jpg', '29', '野生竹荪，口感爽滑、脆嫩，开锅后煮3分钟左右即可食用', '5'),
(NULL, '香菇', 'r9017.jpg', '24', '经过挑选、清洗、切配、装盘而成。锅开后再煮5分钟左右即可食用', '5'),
(NULL, '金针菇', 'r9017.jpg', '28', '经过挑选、清洗、装盘而成。菌盖滑嫩、清脆，锅开后再煮2分钟左右即可食用', '5');
...
(NULL, '1547801000000', '1547824918000', '4', '2'),
(NULL, '1547802000000', '1547834918000', '3', '3'),
(NULL, '1547803000000', '1547834918000', '5', '5'),
(NULL, '1547804000000', '1547854918000', '8', '6'),
(NULL, '1547805000000', '1547834918000', '2', '7'),
(NULL, '1547806000000', '1547874918000', '1', '8'),
(NULL, '1547807000000', '1547884918000', '2', '9'),
(NULL, '1547808000000', '1547834918000', '6', '10'),
(NULL, '1547809000000', '1547804918000', '3', '11'),
(NULL, '1547800000000', '1547834918000', '10', '12'),
(NULL, '1547801000000', '1547824918000', '2', '13'),
(NULL, '1547802000000', '1547834918000', '4', '15');
